...
project's reasoning without combing through git history. Conventions match
`research/whatkey/log/README.md`, copied here so this directory stands on its
own.
...
- When an entry leans on heavy technical jargon, statistics, or math, include a
  **Plain-English reading** section (after Results/Reading, before Decisions)
  ...
  2026-07-07-01 and 2026-07-07-04 in `research/whatkey/log/` are the pattern to
  follow.
